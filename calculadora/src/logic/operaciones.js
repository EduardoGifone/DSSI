...
export default function operaciones (estado, nombreDeBoton) {
  ...
  if (nombreDeBoton === "=") {
    ...
    if (estado.siguiente && estado.operador) {
      return {total: operate(estado.total, estado.siguiente, estado.operador), siguiente: null, operador: null};
    }
  ...
  if (estado.operador) {
    return {total: operate(estado.total, estado.siguiente, estado.operador), siguiente: null, operaddor: nombreDeBoton};
  }

  if (!estado.siguiente) return {operador: nombreDeBoton};

  return {total: estado.siguiente, siguiente: null, operador: nombreDeBoton};
}